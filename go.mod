...
require (
	github.com/bsv-blockchain/go-chaintracks v1.2.2
	...
	github.com/bsv-blockchain/teranode v0.14.2
...
require (
	...
	github.com/bsv-blockchain/testcontainers-aerospike-go v0.3.6 // indirect
