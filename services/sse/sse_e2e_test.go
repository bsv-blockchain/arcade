...
// publishAndPersist mirrors what the api_server intake does in
// production: it writes the status row to the store first, then
// publishes onto the events stream.
