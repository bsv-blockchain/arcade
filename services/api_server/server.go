...
type Server struct {
	...
	// for the dep-aware pipeline. Nil-safe: when unset (some tests use
	// direct struct construction) the handler skips validation, but
	// production wiring through New() requires it.
